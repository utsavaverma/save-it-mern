//This file contains the backend routes for all the food items posted and accepted by the user.
...
//Backend API for posting food requests from restaurant user.
...
//Backend API for fetching food items posted by the restaurant user.
...
//Backend API for accepting food requests by NGO user.
...
//Backend API for generating OTP once the NGO user accepts the food request.
...
//Backend API for confirming the OTP and picking the food item.
